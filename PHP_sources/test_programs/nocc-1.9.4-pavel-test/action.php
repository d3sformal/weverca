...
if (!isset($_REQUEST['sort'])) {
	// Weverca (just to speedup the analysis)
...
if ($_GET[1])
	$action = 'write'; // ok, finds xss
if ($_GET[1])
	$action = 'managefilters'; // ok, finds security problems!!
*/
...
//if ($_GET[1])
	//$action = 'write'; // ok, finds xss
// if ($_GET[1])
 	//$action = 'reply'; // not working: first phase
// if ($_GET[1])
 	//$action = 'managefolders'; // not working: second phase
//if ($_GET[1])
	//$action = 'managefilters'; // ok, finds security problems!!
 //if ($_GET[1])
  	//$action = 'setprefs'; // ok
// if ($_GET[1])
//	  	$action	 = 'login'; // not working: first phase
// $action unset: not working: first phase
