...
if ($_POST) {
	...
	$aaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
	...
	$aaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
	...
	$aaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
	...
	$aaaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaaaaaarr2;
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias = array();
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias2 = 0;
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias3 = 1;
	if ($_POST) {
		$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = &$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias;
		$aaaaaaaaaaaaaaaaaaaaaaaaaaat = $aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[1];
		$aaaaaaaaaaaaaaaaaaaaaaaaaaat[2] = 2;
		$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[1][2] = 3;
		$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[1][3] = 4;
		$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[2][3] = 5;
	} else {
		$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST][2] = 6;
		$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[1][$_POST] = 7;
	}
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[2][1] = &$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias2; // {$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[2][1], $aaaaaaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[2] = &$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias3; // {$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[2], $aaaaaaaaaaaaaaaaaaaaaaaaaaaalias3}, {$aaaaaaaaaaaaaaaaaaaaaaaaaaaalias[1], $aaaaaaaaaaaaaaaaaaaaaaaaaaaalias2}
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr2 = $aaaaaaaaaaaaaaaaaaaaaaaaaaaarr;
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr2[2] = 8; // updates also $aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[2] and $aaaaaaaaaaaaaaaaaaaaaaaaaaaalias3
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr2[3] = 9; // updates also $aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[3] and $aaaaaaaaaaaaaaaaaaaaaaaaaaaalias
	$aaaaaaaaaaaaaaaaaaaaaaaaaaaarr[$_POST] = $aaaaaaaaaaaaaaaaaaaaaaaaaaaarr2;
} else {
	$alias = array();
	$alias2 = 0;
	$alias3 = 1;
