...
$aaarr[$_POST[1]] = $aaarr2;
$aaaalias = array();
$aaaalias2 = 0;
$aaaalias3 = 1;
if ($_POST[1]) {
	$aaaarr[$_POST[1]] = &$aaaalias;
	$aaat = $aaaarr[1];
	$aaat[2] = 2;
	$aaaarr[1][2] = 3;
	$aaaarr[1][3] = 4;
...
$aaaarr[$_POST[1]] = $aaaarr2;
$aaaaaalias = array();
$aaaaaalias2 = 0;
$aaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaarr[$_POST[1]] = &$aaaaaalias;
	$aaaaat = $aaaaaarr[1];
	$aaaaat[2] = 2;
	$aaaaaarr[1][2] = 3;
	$aaaaaarr[1][3] = 4;
	...
	$aaaaaarr[$_POST[1]][2] = 6;
	$aaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaarr[$_POST[1]] = $aaaaaarr2;
$aaaaalias = array();
$aaaaalias2 = 0;
$aaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaarr[$_POST[1]] = &$aaaaalias;
	$aaaat = $aaaaarr[1];
	$aaaat[2] = 2;
	$aaaaarr[1][2] = 3;
	$aaaaarr[1][3] = 4;
...
$aaaaarr[$_POST[1]] = $aaaaarr2;
$aaaaaaalias = array();
$aaaaaaalias2 = 0;
$aaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaarr[$_POST[1]] = &$aaaaaaalias;
	$aaaaaat = $aaaaaaarr[1];
	$aaaaaat[2] = 2;
	$aaaaaaarr[1][2] = 3;
	$aaaaaaarr[1][3] = 4;
	...
	$aaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaarr[$_POST[1]] = $aaaaaaarr2;
$aaaaaaaalias = array();
$aaaaaaaalias2 = 0;
$aaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaarr[$_POST[1]] = &$aaaaaaaalias;
	...
	$aaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaarr[$_POST[1]] = $aaaaaaaarr2;
$aaaaaaaaaalias = array();
$aaaaaaaaaalias2 = 0;
$aaaaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaaaarr[$_POST[1]] = &$aaaaaaaaaalias;
	...
	$aaaaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaaaarr[$_POST[1]] = $aaaaaaaaaarr2;
$aaaaaalias = array();
$aaaaaalias2 = 0;
$aaaaaalias3 = 1;
if ($_POST[1]) {
...
$aaaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaaarr[$_POST[1]] = &$aaaaaaaaalias;
	...
	$aaaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaaarr[$_POST[1]] = $aaaaaaaaarr2;
$aaaaaaaaaaalias = array();
$aaaaaaaaaaalias2 = 0;
$aaaaaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaaaaarr[$_POST[1]] = &$aaaaaaaaaaalias;
	...
	$aaaaaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaaaaarr[$_POST[1]] = $aaaaaaaaaaarr2;
$aaaaaaaaaalias = array();
$aaaaaaaaaalias2 = 0;
$aaaaaaaaaalias3 = 1;
if ($_POST[1]) {
...
$aaaaaaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaaaaaarr[$_POST[1]] = &$aaaaaaaaaaaalias;
	...
	$aaaaaaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaaaaaarr[$_POST[1]] = $aaaaaaaaaaaarr2;
$aaaaaaaaaaaaalias = array();
$aaaaaaaaaaaaalias2 = 0;
$aaaaaaaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaaaaaaarr[$_POST[1]] = &$aaaaaaaaaaaaalias;
	...
	$aaaaaaaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaaaaaaarr[$_POST[1]] = $aaaaaaaaaaaaarr2;
$aaaaaaaaaaaaaaalias = array();
$aaaaaaaaaaaaaaalias2 = 0;
$aaaaaaaaaaaaaaalias3 = 1;
if ($_POST[1]) {
	$aaaaaaaaaaaaaaarr[$_POST[1]] = &$aaaaaaaaaaaaaaalias;
	...
	$aaaaaaaaaaaaaaarr[$_POST[1]][2] = 6;
	$aaaaaaaaaaaaaaarr[1][$_POST[1]] = 7;
}
...
$aaaaaaaaaaaaaaarr[$_POST[1]] = $aaaaaaaaaaaaaaarr2;
?>