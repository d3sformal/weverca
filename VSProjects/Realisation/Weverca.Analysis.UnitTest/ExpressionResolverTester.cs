...
namespace Weverca.Analysis.UnitTest
{
    ...
    public class ExpressionEvaluatorTester
    {
        ...
        private static readonly Value[] inputValuesBinary = new Value[]
        {
            ...
            new IntegerValue(1618033),
            new IntegerValue(0),
            // Not supported: new LongintValue(-273L),
            new FloatValue(3.141592),
            new FloatValue(-271000000000000000000.0),
            new StringValue("Weverka"),
            new StringValue("256"),
            ...
            new UndefinedValue(),
            new IntegerIntervalValue(-541, 954),
            new IntegerIntervalValue(-758956, -5447),
            // Not supported: new LongintIntervalValue(-789, -111),
            new FloatIntervalValue(1057.785, 2457.445),
            new AnyValue(),
            new AnyBooleanValue(),
            new AnyIntegerValue(),
            // Not supported: new AnyLongintValue(),
            new AnyFloatValue(),
            new AnyStringValue(),
            new AnyObjectValue(),
            new AnyArrayValue(),
