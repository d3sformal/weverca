...
namespace Weverca
{
    ...
    public static class Analyzer
    {
        ...
        public static ProgramPointGraph Run(FileInfo entryFile, MemoryModels.MemoryModels memoryModel)
        {
            var cfg = GenerateCfg(entryFile);
            return Analyze(cfg, entryFile, memoryModel);
        }
        ...
        /// <param name="memoryModel">The memory model used for analysis</param>
        /// <returns>PPG generated by forward analysis</returns>
        internal static ProgramPointGraph Analyze(ControlFlowGraph.ControlFlowGraph entryMethod, FileInfo entryFile, MemoryModels.MemoryModels memoryModel)
        {
            var analysis = new ForwardAnalysis(entryMethod, memoryModel, entryFile);
        ...
        internal static ControlFlowGraph.ControlFlowGraph GenerateCfg(FileInfo fileInfo)
        {
            ...
            return ControlFlowGraph.ControlFlowGraph.FromFilename(fileName);
        }
