...
namespace Weverca
{
    ...
    public static class Analyzer
    {
        ...
        public static ProgramPointGraph Run(FileInfo entryFile)
        {
            var cfg = GenerateCfg(entryFile);
            return Analyze(cfg, entryFile);
        }
        ...
        /// <param name="entryFile">File with PHP source</param>
        /// <returns>PPG generated by forward analysis</returns>
        internal static ProgramPointGraph Analyze(ControlFlowGraph.ControlFlowGraph entryMethod, FileInfo entryFile)
        {
            var analysis = new ForwardAnalysis(entryMethod, MemoryModels.MemoryModels.VirtualReferenceMM, entryFile);
