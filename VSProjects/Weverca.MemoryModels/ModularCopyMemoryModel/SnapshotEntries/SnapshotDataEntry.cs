...
namespace Weverca.MemoryModels.ModularCopyMemoryModel.SnapshotEntries
{
    ...
    /// </summary>
    public class SnapshotDataEntry : ReadWriteSnapshotEntryBase, ICopyModelSnapshotEntry
    {
        /// <summary>
        /// The data entry
        /// </summary>
        ...
        public SnapshotDataEntry(Snapshot snapshot, MemoryEntry entry)
        {
        ...
        private SnapshotEntry getTemporary(SnapshotBase context)
        {
            ...
            if (temporaryLocation == null)
            {
                ...
                snapshot.Factories.Benchmark.StartAlgorithm(snapshot, algorithm, AlgorithmType.MERGE_TO_TEMPORARY);
                algorithm.MergeMemoryEntry(snapshot, temporaryIndex, dataEntry);
                snapshot.Factories.Benchmark.FinishAlgorithm(snapshot, algorithm, AlgorithmType.MERGE_TO_TEMPORARY);
            }
